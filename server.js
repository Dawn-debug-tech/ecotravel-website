...
if (posts.length === 0) {
    const fakeNames = [
        "Aarav P.", "Vihaan S.", "Aditya K.", "Arjun M.", "Sai T.", "Rohan N.", "Krishna V.", "Ishaan R.", "Shaurya D.", "Ayaan C.",
        "Dhruv G.", "Kabir B.", "Ritvik H.", "Pranav J.", "Atharv L.", "Rishabh Y.", "Ananya K.", "Diya M.", "Sanya S.", "Aarohi R.",
        "Riya C.", "Navya P.", "Kavya T.", "Avni G.", "Isha V.", "Anika D.", "Mahi N.", "Khushi J.", "Sara B.", "Ridhi H.",
        "Pooja L.", "Nidhi Y.", "Neha P.", "Priya S.", "Rachna M.", "Swati T.", "Prakash R.", "Amit D.", "Rahul C.", "Vikram G."
    ];
    const glowingReviews = [
        "Absolutely breathtaking! Would highly recommend this to anyone looking for a true adventure.",
        "A life-changing experience. The locals were so welcoming and the sights were unforgettable.",
        "One of the best trips I've ever taken. The commitment to sustainability is really inspiring.",
        "Stunning views and incredible wildlife. I can't wait to go back!",
        "Perfect getaway! Peaceful, beautiful, and completely immersed in nature.",
        "Highly recommended! The preservation efforts here are top notch.",
        "Incredible scenery and very knowledgeable guides. Worth every penny.",
        "A beautiful, pristine environment. I loved the eco-friendly accommodations.",
        "An unforgettable journey. Simply stunning.",
        "Top tier eco-tourism. Learned so much and had a blast."
    ];

    let availableNames = [...fakeNames].sort(() => 0.5 - Math.random());

    for (let destId = 1; destId <= 13; destId++) {
        const numReviews = Math.floor(Math.random() * 3) + 2;
        for (let i = 0; i < numReviews; i++) {
            const authorName = availableNames.pop() || "Guest Traveler";
            posts.push({
                id: Date.now() + Math.random(),
                destinationId: destId,
                author: authorName,
                text: glowingReviews[Math.floor(Math.random() * glowingReviews.length)],
